...
# openwrt nodes
$(eval $(call build-node,ap-living,22.03.0-rc4,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-bedroom,22.03.0-rc4,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-guest,22.03.0-rc4,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-max,22.03.0-rc4,ath79,generic,tplink_archer-c7-v2))
$(eval $(call build-node,ap-balcony,22.03.0-rc4,ath79,generic,tplink_archer-c7-v2))

$(eval $(call build-node,router,22.03.0-rc4,ramips,mt7621,ubnt_edgerouter-x))
$(eval $(call build-node,switch,22.03.0-rc4,ramips,mt7621,ubnt_edgerouter-x))
