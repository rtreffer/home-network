...
$(eval $(call openwrt-build-container,23.05.0,ath79,generic))
$(eval $(call openwrt-build-container,23.05.0,ramips,mt7621))
$(eval $(call openwrt-build-container,23.05.0,bcm27xx,bcm2708))
$(eval $(call openwrt-build-container,23.05.0,bcm27xx,bcm2710))
$(eval $(call openwrt-build-container,23.05.0,realtek,rtl838x))

# openwrt nodes
$(eval $(call build-node,ap-living,23.05.0,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-bedroom,23.05.0,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-guest,23.05.0,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-max,23.05.0,ramips,mt7621,totolink_x5000r))
$(eval $(call build-node,ap-balcony,23.05.0,ath79,generic,tplink_archer-c7-v2))

$(eval $(call build-node,router,23.05.0,ramips,mt7621,ubnt_edgerouter-x))
$(eval $(call build-node,switch,23.05.0,ramips,mt7621,ubnt_edgerouter-x))
...
$(eval $(call build-node,core-switch,23.05.0,realtek,rtl838x,d-link_dgs-1210-28))
