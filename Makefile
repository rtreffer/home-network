...
$(eval $(call openwrt-build-container,22.03.3,ath79,generic))
$(eval $(call openwrt-build-container,22.03.3,ramips,mt7621))
$(eval $(call openwrt-build-container,23.05.0-rc2,ramips,mt7621))


# openwrt nodes
$(eval $(call build-node,ap-living,23.05.0-rc2,ramips,mt7621,totolink_x5000r))
...
$(eval $(call build-node,ap-max,23.05.0-rc2,ramips,mt7621,totolink_x5000r))
